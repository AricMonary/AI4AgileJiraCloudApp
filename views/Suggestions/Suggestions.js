...
{
    static paramtersFromURL = {}

    static suggestionsCreated = false;
    static suggestionCount = 0;
    static suggestions = {
        listOfSuggestions: [],
        get list() {
    ...
    static async generateSuggestions(processType, issueKey, sliderValue) {
    ...
    static checkAllSuggestions(checked) {
    ...
    static createSelectedSuggestions() {
    ...
    static suggestionDeleted(suggestion) {
    ...
    static changeButtonState(state) {
